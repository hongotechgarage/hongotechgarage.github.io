...
|S1|S2|A1|
| --- | --- | --- |
| スタートアップの考え方やアイデアの見つけ方 | スタートアップを成長させるための知識やスキル | 学んできたものを実践する |
...
授業の各回に対して、Readings を提示しています。ただしこれらを読むのは requirement ではありません。重要なトピックについては授業でカバーしています。

## 小テスト (Assessment)

小テストは授業中に実施される、皆さんの理解を助けるものとして用意しています。

#### 小テストの位置づけ

小テストは Assessment であり Evaluation と少し異なります。Assessment と Evaluation の違いは、Assessment は皆さんの授業の理解を支援するもの、Evaluation は最終評価だとお考え下さい。点数はつきますが、自分の理解を測り、次につなげていくものとして小テストを活用してください。


## 評価方法 (Grading / Evaluation)
...
|  小テスト | 6 | 2 | 12 |
|  宿題 | 6 | 5 | 30 |
|  中間レポートの提出とレビュー | 1 | 15 | 15 |
|  最終レポートの提出とレビュー | 1 | 15 | 15 |
|  その他の活動 | - | - | 30 |
|  合計 |  |  | 130 |

- 宿題はすべて期日通りに提出したものを評価します。
- 中間レポートは参加すれば8点を付与し、残りの7点は相互評価からの中央値を取ります。
- 最終レポートは参加すれば8点を付与し、残りの7点は相互評価からの中央値を取ります。

|  **その他の活動** | **回数** | **各回の点数** | **最大点数** |
|  ------ | ------ | ------ | ------ |
|  Gavel で全員のアイデアを評価してくる | 4 | 2 | 8 |
|  学生人気投票で1～3位 | 6 | 3 | 18 |
|  心理尺度の協力 | 2 | 2 | 4 |
...
- 宿題はすべて期日通りに提出したものを評価します。
- アイデアは出せば5点、次のステージに残れば10点を付与します
    - 次のステージに残れなかった場合は、「その他の活動」での「アドバイス」評点で最大 5 点を獲得できます
- 投資結果については、下記のリターンの計算式を参考にしてください。
- 最終レポートは参加すれば8点を付与し、残りの7点は相互評価からの中央値を取ります。
...
- アドバイス評点は、「手伝ってくれた人」のアンケートでほかの人から点数が付与されます
- 投資の1位を取った人には、通常の投資結果に加えて15点の加点、2位の人には5点加点をします

#### s2 の投資結果の計算式（リターンの計算式）

|  **投資前提** | **順位付け** | **時価総額算出** | **評価** |
|  ------ | ------ | ------ | ------ |
|  ・10億円持っている<br/>・シードの時は時価総額は1億円で10%を買える<br/>・Series Aは1億円で10%を買える | Gavel での順位付け<br/>Series Aにいけるのは15% | ・1位が1000億円<br/>・2位が500億円<br/>・3位が200億円<br/>・4位が100億円<br/>・5位が50億円 | ・5億円以上持っていたら3点<br/>・10億円以上持っていたら6点<br/>・40億円以上持っていたら10点<br/>・投資しないと0点（離反） |
...
- [EDGE Next](https://www.ducr.u-tokyo.ac.jp/activity/venture/education/edge.html)
- 
...
HONDA の創業者である本田宗一郎氏による自伝です。創業当初の様子を見ることができるでしょう。

**[Made in Japan]( http://amzn.asia/dIOmByr)**
SONY の創業者である盛田昭夫氏による振り返りの書籍です。SONY の初期のころの話を読みたいときにも便利な本です。
...
David Foster WallaceがKenyon大学で行った卒業スピーチの
日本語での書き起こしです。リベラルアーツは「自分の頭で考えること」を促してくれますが、それはスタートアップを考えるうえで重要なことのように思えます。（馬田）
...
「ソニー自叙伝」の一部抜粋です。SONY の初期のころを簡単に読みたいときはこちらが便利です。
...
Google による、自社でのデータを活かした人材活用方法について。
...
](https://www.slideshare.net/takaumada/design-sprint-guidebook-v2)**
...
原題は「」で合理的な楽観主義Rational Optimist です。

**[楽観主義者の未来予測]()**
テクノユートピア思想では「シンギュラリティ」などが有名ですが、

**[Enlightenment Now]()**
Pinker 前著『暴力の人類史』でカバーしていたもの以外。
...
どのように人のつながりが人の行動を変えるかといった社会的ネットワーク分析の本ですが、幸福は伝染する、などの興味深い研究なども含まれています。
...
**[ベンチャーの実態　（上）](http://blog.livedoor.jp/lionfan/archives/52909351.html)[（中）]()[（下）]()**
スタートアップで働くということがどういうことかを
...
Google の。コンピュータサイエンス系が中心になっていますが、他の企業や領域でも使えるTipsになっています。

**[Climbing the wrong hill
](http://cdixon.org/2009/09/19/climbing-the-wrong-hill/)**
キャリアの最初に間違った坂を上らないために。

**[Stanford Career Education (BEAM: Bridging Education, Ambition & Meaningful Work
)](https://beam.stanford.edu/students/digital-resources)**
Stanford University の。他大学のキャリアセンターよりもリソースが多く、お勧めです（ポスドクや Ph.D 向けのものもあります）。
...
**[会社を売却すると、創業者の身に何が起こるか](https://irnote.com/n/nea937e45145f)**

**[それぞれのHARD THINGS](http://matching-project-x-blog.com/everyones-had-things-takamasakamio/)**
一つの事例として。
...
**[“How to Raise Money” by Paul Graham 和訳](http://blog-ja.gengo.com/ja/y-combinator-paul-graham-sept-essay-fundraising-ja-translation/)**

**[翻訳 A Guide to Seed Fundraising | The Macro](https://qiita.com/shinodogg/items/8b463589985f3de36247)**





### Week 9 (6/13) / 戦略とビジネスモデル
...
**[イノベーションのジレンマ]()**
大企業がはまってしまう戦略上の落とし穴について語られています。逆に言えばスタートアップはこうした落とし穴を狙って事業成長ができます。
...
**[Competition is for Losers](http://startupclass.samaltman.com/courses/lec05/)**
...
**[クリエイティブマインドセット](http://amzn.asia/amG2dBb)**
...
**[Talking to Humans](https://www.talkingtohumans.com/download)**
インタビューのやりかたについて。

**[人間と話す](https://www.slideshare.net/takaumada/lean-customer-development-lean-startup-update-2015)**
...
**[スタートアップ ＝ 成長
](https://perapera.co/paul-graham/ja/startup-growth)**

**[スケールしないことをしよう](https://postd.cc/do-things-that-dont-scale/)**
...
**[アイデアのちから](http://amzn.asia/78V0Nas)**

刺さるアイデアの条件としての SUCCESs フレームワークを提唱しています。メッセージングが重要なアイデアはこちらを参照すると良いでしょう（馬田）
...
**[スタートアップの 3 分ピッチテンプレート](https://www.slideshare.net/takaumada/startup-pitch-template3min)**

**[Airbnb の初期ピッチ資料は YC の 3 分ピッチテンプレート通り](https://medium.com/@tumada/3-min-pitch-airbnb-203021531522)**
...
**[投資家が資金調達の際に聞く30の質問
](https://perapera.co/alex-iskold/ja/30-questions-investors-ask-during-fundraising)**
...
Y Combinator による 2015 年の Stanford での授業です。今回
