...
プロダクト（人々の欲しがるもの）を作るというプロジェクトを成功させるためには、
...
学生の皆さんのたくさんのプロダクト開発を見る中で、良いアイデアなのにうまく進まいないという状況を何度も見てきました。

このコースはそうした経験から、皆さんのプロジェクトの成功確率を上げるために作られたコースです。

もちろん、プロジェクトの遂行が成功しても、プロダクトとしてインパクトを与えられないという意味で失敗してしまうかもしれません。しかしインパクトがあるかどうかのアイデアを判別するためには、プロジェクトをきちんと遂行して、顧客に問わなければ分かりません。
...
- Project Fund や Summer Founders Program などで一度自分のアイデアの技術プロジェクトを試した人が、改めてプロジェクトを始める前に受けると効果的です。
- 技術的なスキルを身につけることはできません。チームを巻き込んだマネジメントのスキルを学ぶことができます。
